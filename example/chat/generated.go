...
func (ec *executionContext) _Chatroom_messages(ctx context.Context, field graphql.CollectedField, obj *Chatroom) (ret graphql.Marshaler) {
	...
	res := resTmp.([]Message)
	fc.Result = res
	return ec.marshalNMessage2ᚕgithubᚗcomᚋswiftcarrotᚋgqlgenᚋexampleᚋchatᚐMessageᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_post(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*Message)
	fc.Result = res
	return ec.marshalNMessage2ᚖgithubᚗcomᚋswiftcarrotᚋgqlgenᚋexampleᚋchatᚐMessage(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_room(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*Chatroom)
	fc.Result = res
	return ec.marshalOChatroom2ᚖgithubᚗcomᚋswiftcarrotᚋgqlgenᚋexampleᚋchatᚐChatroom(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Subscription_messageAdded(ctx context.Context, field graphql.CollectedField) (ret func() graphql.Marshaler) {
	...
	return func() graphql.Marshaler {
		...
		return graphql.WriterFunc(func(w io.Writer) {
			...
			w.Write([]byte{':'})
			ec.marshalNMessage2ᚖgithubᚗcomᚋswiftcarrotᚋgqlgenᚋexampleᚋchatᚐMessage(ctx, field.Selections, res).MarshalGQL(w)
			w.Write([]byte{'}'})
		})
	}
}
...
func (ec *executionContext) marshalNMessage2githubᚗcomᚋswiftcarrotᚋgqlgenᚋexampleᚋchatᚐMessage(ctx context.Context, sel ast.SelectionSet, v Message) graphql.Marshaler {
	return ec._Message(ctx, sel, &v)
}

func (ec *executionContext) marshalNMessage2ᚕgithubᚗcomᚋswiftcarrotᚋgqlgenᚋexampleᚋchatᚐMessageᚄ(ctx context.Context, sel ast.SelectionSet, v []Message) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNMessage2githubᚗcomᚋswiftcarrotᚋgqlgenᚋexampleᚋchatᚐMessage(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNMessage2ᚖgithubᚗcomᚋswiftcarrotᚋgqlgenᚋexampleᚋchatᚐMessage(ctx context.Context, sel ast.SelectionSet, v *Message) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) marshalOChatroom2ᚖgithubᚗcomᚋswiftcarrotᚋgqlgenᚋexampleᚋchatᚐChatroom(ctx context.Context, sel ast.SelectionSet, v *Chatroom) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
