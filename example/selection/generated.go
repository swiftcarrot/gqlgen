...
func (ec *executionContext) _Query_events(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]Event)
	fc.Result = res
	return ec.marshalOEvent2ᚕgithubᚗcomᚋswiftcarrotᚋgqlgenᚋexampleᚋselectionᚐEventᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNEvent2githubᚗcomᚋswiftcarrotᚋgqlgenᚋexampleᚋselectionᚐEvent(ctx context.Context, sel ast.SelectionSet, v Event) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) marshalOEvent2ᚕgithubᚗcomᚋswiftcarrotᚋgqlgenᚋexampleᚋselectionᚐEventᚄ(ctx context.Context, sel ast.SelectionSet, v []Event) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNEvent2githubᚗcomᚋswiftcarrotᚋgqlgenᚋexampleᚋselectionᚐEvent(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
